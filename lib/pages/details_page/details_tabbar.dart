  ...
  Widget _myTabBarLeft(BuildContext context, bool isLeft) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Colors.white, border: Border(bottom: BorderSide(width: 1.0, color: isLeft ? Colors.pink : Colors.black12))),
        child: Text(
          '详细',
  ...
  Widget _myTabBarRight(BuildContext context, bool isRight) {
    return InkWell(
      ...
      child: Container(
        ...
        alignment: Alignment.center,
        width: ScreenUtil().setWidth(375),
        decoration: BoxDecoration(color: Colors.white, border: Border(bottom: BorderSide(width: 1.0, color: isRight ? Colors.pink : Colors.black12))),
